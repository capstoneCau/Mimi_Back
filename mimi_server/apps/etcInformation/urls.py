...
router.register(r'compatibility/mbti', MbtiCompatibilityViewSet, 'mbtiCompatibility')
router.register(r'compatibility/star', StarCompatibilityViewSet, 'starCompatibility')
router.register(r'compatibility/zodiac', ZodiacCompatibilityViewSet, 'zodiacCompatibility')
